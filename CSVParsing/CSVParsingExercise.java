...
/**
 * Write a description of CSVParsingExercise here.
 * 
 * @author (your name) 
...
public class CSVParsingExercise {
    ...
    public void testColdestHourInFile () {
        ...
        System.out.println ("Coldest Temp: " + record.get("TemperatureF") + ", Coldest Hour: "
                            + record.get("TimeEST") + ", Date: " + record.get("DateUTC"));
    ...
    public void testAverageTemperatureWithHighHumidityInFile () {
        ...
        {
            System.out.println ("Average Temp when High Humidity is: " + value + " is: " + averageHighTemp); 
        }
    ...
    public static void main (String[] args) {
        ...
        CSVParsingExercise csv = new CSVParsingExercise();
        //csv.testColdestHourInFile();        
        //csv.testFileWithColdestTemperature();
        //csv.testColdestHourInMultipleFiles();
